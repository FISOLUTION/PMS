...
public class InitDb {
    ...
    static class InitService {
        ...
        public void dbInit() {
            ...
            Files files1 = createFile(office1, "000001", "001", F_process.IMGMODIFY, "5", "005", "강남구청 인사과", "2021", F_kperiod.SEMI, F_kmethod.ALL, F_kplace.PROFESSION, "2021", "2021", F_construct.YES, F_construct.YES, "99999999", F_type.GENERAL, F_newold.OLD, F_modify.NOTHING, "000100", "500", "0", F_inheritance.NONE, "0", "0", "0", f_location);
            em.persist(files1);

            Files files2 = createFile(office1, "000002", "002", F_process.UPLOAD, "3", "003", "경기도 안양시", "1990", F_kperiod.PERMANENT, F_kmethod.ORIGINAL, F_kplace.ARCHIVIST, "1990", "1995", F_construct.YES, F_construct.NO, "99999999", F_type.CARD, F_newold.OLD, F_modify.MODIFY, "00666", "984", "0", F_inheritance.NONE, "0", "0", "0", f_location);
            em.persist(files2);

            Files files3 = createFile(office2, "000003", "001", F_process.INPUT, "5", "005", "강남구청 인사과", "2021", F_kperiod.SEMI, F_kmethod.ALL, F_kplace.PROFESSION, "2021", "2021", F_construct.YES, F_construct.YES, "99999999", F_type.GENERAL, F_newold.OLD, F_modify.NOTHING, "000100", "500", "0", F_inheritance.NONE,"0", "0", "0", f_location);
            em.persist(files3);

            Files files4 = createFile(office5, "000004", "004", F_process.CHECK, "5", "005", "강남구청 인사과 안녕하세요 인사과입니다 안뇽뇽", "2024", F_kperiod.SEMI, F_kmethod.ALL, F_kplace.PROFESSION, "2024", "2024", F_construct.YES, F_construct.YES, "99999999", F_type.GENERAL, F_newold.OLD, F_modify.NOTHING, "000400", "500", "0", F_inheritance.NONE, "0", "0", "0", f_location);
            em.persist(files4);

            Files files5 = createFile(office5, "000005", "005", F_process.CHECK, "3", "003", "안양시청 실내수영장 10월 일정표", "2025", F_kperiod.SEMI, F_kmethod.ALL, F_kplace.PROFESSION, "2025", "2025", F_construct.YES, F_construct.YES, "99999999", F_type.GENERAL, F_newold.OLD, F_modify.NOTHING, "000500", "500", "0", F_inheritance.NONE,  "0", "0", "0", f_location);
            em.persist(files5);

            Files files6 = createFile(office1, "000006", "006", F_process.CHECK, "10", "010", "금천구청 ...", "2000", F_kperiod.SEMI, F_kmethod.ALL, F_kplace.PROFESSION, "2000", "2001", F_construct.NO, F_construct.YES, "99999999", F_type.GENERAL, F_newold.OLD, F_modify.NOTHING, "000600", "600", "0", F_inheritance.NONE, "0", "0", "0", f_location);
            em.persist(files6);

            Files files7 = createFile(office2, "000007", "007", F_process.CHECK, "8", "008", "경기도 ...", "1999", F_kperiod.SEMI, F_kmethod.ALL, F_kplace.PROFESSION, "1999", "1999", F_construct.NO, F_construct.NO, "99999999", F_type.GENERAL, F_newold.OLD, F_modify.NOTHING, "000700", "700", "0", F_inheritance.NONE, "0", "0", "0", f_location);
            em.persist(files7);
